...
public class DigesterBlockEntity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory {
    ...
    public DigesterBlockEntity(BlockPos pos, BlockState state){
        super(ModBlockEntities.DIGESTER, pos ,state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> DigesterBlockEntity.this.progress;
                    case 1 -> DigesterBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index){
                    case 0 -> DigesterBlockEntity.this.progress = value;
                    case 1 -> DigesterBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName(){
        return Text.translatable("block.moneycraft.digester");
    }
